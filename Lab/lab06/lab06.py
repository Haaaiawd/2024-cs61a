class Transaction:
    ...
    def report(self):
        ...
        if self.changed():
            "*** YOUR CODE HERE ***"
            msg = 'increased' + " " + str(self.before) + '->' + str(self.after) if self.before < self.after else 'decreased' + " " + str(self.before) + '->' + str(self.after)
...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        ##用len(self.transactions)来记录交易的次数很聪明
...
class Client:
    ...
    def compose(self, message, recipient_name):
        ...
        email = Email(message, Client, recipient_name)
